...
public class GMShape{
    public static void main(String[] args){
        Point point = new Point(2, 3);
        Line line = new Line(1, 4, 4, 8);
        ...
        Hyperbola hyperbola = new Hyperbola(5, 3);
        ...
        // Quadrangle
        quadrangle.square(5);
        quadrangle.rectangle(4, 7);
        quadrangle.parallelogram(5, 10);
        quadrangle.trapezoid(3, 8, 6);
        quadrangle.rhombus(6, 8);
        // Others
        circle.display();
        ellipse.display();
        hyperbola.display();
